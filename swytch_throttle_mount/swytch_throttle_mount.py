...
def instance():
    bar_diameter = 22
    clamp_width = 10
    stub_height_above_bar = 22 + 7
    stub_clamp_thickness = 3
    ...
    m = (
        ...
        .rotate((0, 0, stub_height_above_bar - stub_clamp_thickness), #extrude/2),
                (0, 1, stub_height_above_bar - stub_clamp_thickness), #extrude/2),
